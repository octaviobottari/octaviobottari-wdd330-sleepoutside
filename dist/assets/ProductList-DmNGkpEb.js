import { r as i } from "./utils-CzYKsxI9.js";
class d {
  constructor(e, a, t) {
    (this.category = e), (this.dataSource = a), (this.listElement = t);
  }
  async init() {
  ...
  productCardTemplate(e) {
    var r, s;
    const a =
        ((r = e.Images) == null ? void 0 : r.PrimaryMedium) || e.Image || "",
      t = encodeURI(a);
    return `
